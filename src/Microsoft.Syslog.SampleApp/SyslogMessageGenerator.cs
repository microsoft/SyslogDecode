...
namespace Microsoft.Syslog.SampleApp
{
    using System;
    ...
    public static class SyslogMessageGenerator
    {
        ...
        static string MessageTemplate_RFC5424 = @"<14>1 2020-06-25T08:18:31.784Z ABCD-4444-abcd-55 RT_FLOW - RT_FLOW_SESSION_DENY
...
SNMP Authentication failure for SNMP request from host {0}-Error:Snmp Unknown community".Replace(Environment.NewLine, " ");
        ...
        static string MessageTemplate_KeyValuePairs = @"<189> date=2020-06-25 time=01:18:32 devname=xyz-dd33d-f0peg-1a devid=ASDFAERFA logid=0000000013 type=traffic
subtype=forward level=notice vd=FOPEG srcip={0} srcport=49612 srcintf='FE_UNTRUST' dstip={1} dstport=555666 dstintf='EOP-INTERNAL'
poluuid=FFFFF-7777-6666-2222-ASDFASDFASDF sessionid=22222333334444 proto=6 action=deny policyid=136 dstcountry='United States' srccountry='United States'
trandisp=noop service='tcp/456' duration=0 sentbyte=0 rcvdbyte=0 sentpkt=0 appcat='unscanned' crscore=30 craction=222333444crlevel=high".Replace(Environment.NewLine, " ").Replace('"', '\'');
